...
// Import dynamique pour Leaflet (évite window is not defined)
const ZonesDesserviesMap = dynamic(() => import("./ZonesDesserviesMap"), {
  ssr: false,
})
...
export default function HomeClient() {
  ...
  const zones = [
    "Toulouse","Blagnac","Muret","Colomiers","Balma","Ramonville","Castanet",
    "Tournefeuille","SaintOrens","Labège","Cugnaux","LUnion","PortetSurGaronne",
    "Fenouillet","PlaisanceDuTouch"
  ]
      ...
      <section className="relative h-[90vh] flex items-center justify-center text-center">
        ...
        <div className="relative z-10 max-w-3xl px-6 text-white">
          ...
          <p className="mb-8 text-lg md:text-xl text-white/90">
            Occitanie entière desservie ! Transport médicalisé Toulouse et sa région. Conventionné CPAM/Sécurité Sociale.
          </p>
